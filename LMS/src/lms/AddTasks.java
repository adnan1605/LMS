...
/*
	...
	*/
	...
	JLabel l3 = new JLabel("user_email");
...
/*
	...
	*/
	...
	panel.setBorder(new TitledBorder(new LineBorder(new Color(138, 43, 226), 2), "Add Tasks", TitledBorder.LEADING,
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            conn con = new conn();
            if(ae.getSource() == b1){
                String sql = "insert into task_matcher(task,user) values( ?, ?)";

	...
	public static void main(String[] args) {
        ...
        public user_home() {
           ...
           // menuBar.setBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(0, 128, 0), new Color(128, 128, 128)));
            ...
            JMenuItem bookdetails = new JMenuItem("user Details");
            ...
            /*
            JMenuItem studentdetails = new JMenuItem(" Details");
            ...
            ImageIcon i1  = new ImageIcon(this.getClass().getResource("/second.png"));
            ...
            ImageIcon i4  = new ImageIcon(this.getClass().getResource("/third.png"));
            ...
            ImageIcon i7  = new ImageIcon(this.getClass().getResource("/fourth.png"));
            ...
            ImageIcon i10  = new ImageIcon(this.getClass().getResource("/fifth.png"));
...
/*
            ...
            ImageIcon i13  = new ImageIcon(this.getClass().getResource("/sixth.png"));
            ...
            ImageIcon i16  = new ImageIcon(this.getClass().getResource("/seventh.png"));
		...
		//new BookDetails().setVisible(true);
            ...
            if(ae.getSource() == b3){
                this.setVisible(false);
               new progressTask().setVisible(true);
            }
            if(ae.getSource() == b3){
                this.setVisible(false);

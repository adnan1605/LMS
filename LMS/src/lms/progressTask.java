...
public class progressTask extends JFrame implements ActionListener{
    ...
    public progressTask() {
    	...
    	JFrame a=new JFrame("progress Task");
    	
       a.setBounds(600, 250, 606, 406);
        ...
        JLabel lblUsername = new JLabel("progress :");
...
/*
        ...
        */
        ...
        String str[]= {" started","25%","50%","75%","completed"};
		 comboBox = new JComboBox(str);
		 comboBox.setBounds(265,60,95,24);
	        contentPane.add(comboBox);
	       /*
	        JLabel lblSecurityQuestion = new JLabel("progress :");
	        lblSecurityQuestion.setForeground(Color.DARK_GRAY);
	        lblSecurityQuestion.setFont(new Font("Tahoma", Font.BOLD, 14));
	        lblSecurityQuestion.setBounds(124,60,95,24);
        ...
        comboBox.setModel(new DefaultComboBoxModel(new String[] { "Your NickName?", "Your Lucky Number?",
			"Your BestFriend Name?", "Your childhood Name ?" }));
...
*/
        ...
        panel.setBorder(new TitledBorder(new LineBorder(new Color(128, 128, 0), 2), "Progess of Task",
